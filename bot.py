...
BALANCE = float(os.environ.get("8792351652:AAFCn7phqBtQPLKY0I2hNKoyRRgsGdrTL8U", "1000"))
...
TIMEFRAMES = {
    # ملحوظة: yfinance بيسمح ببيانات الدقيقة الواحدة لحد 7 أيام بالظبط، فبنستخدم 6 أيام
    # كهامش أمان عشان الطلب ميترفضش لو حصل أي فرق بسيط في التوقيت
    "3د":  {"interval": "1m",  "period": "6d",  "resample": "3min",  "label": "3 دقائق",  "bars": 40, "exp": "03:00"},
    "5د":  {"interval": "5m",  "period": "5d",  "resample": None,    "label": "5 دقائق",  "bars": 60, "exp": "05:00"},
    "10د": {"interval": "1m",  "period": "6d",  "resample": "10min", "label": "10 دقائق", "bars": 40, "exp": "10:00"},

...
# ⏱ الأطر الزمنية
# ==============================================
# ملحوظة: yfinance مش بيدعم فريمات 3 و10 دقايق مباشرة، فبنجيبها
# عن طريق سحب بيانات الدقيقة الواحدة الخام وتجميعها (resample) لشموع 3د/10د.
# الفريمات اللي عندها "resample" = None بتتجاب من yfinance مباشرة.
TIMEFRAMES = {
    "3د":  {"interval": "1m",  "period": "7d",  "resample": "3min",  "label": "3 دقائق",  "bars": 40, "exp": "03:00"},
    "5د":  {"interval": "5m",  "period": "5d",  "resample": None,    "label": "5 دقائق",  "bars": 60, "exp": "05:00"},
    "10د": {"interval": "1m",  "period": "7d",  "resample": "10min", "label": "10 دقائق", "bars": 40, "exp": "10:00"},

...
# ⚙️ إعدادات التحليل الجديدة
MAIN_TF        = "5د"        # الإطار الأساسي
CONFIRM_TFS    = ["15د"]     # أطر للتأكيد
MIN_CONFIRM    = 1           # نحتاج إطار واحد على الأقل يوافق
MIN_SCORE      = 5           # الحد الأدنى للنقاط
ADX_THRESHOLD  = 25          # لا إشارة إذا كان ADX أقل من هذا الرقم
COOLDOWN       = 300         # ثوانٍ بين الإشارات المتكررة
FETCH_DELAY    = 2.0
...
def analyze(df):
    ...
    # فلتر أساسي: لا إشارة إذا لم يكن هناك اتجاه واضح

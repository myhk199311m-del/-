...
# ==============================================
# ⚙️ الإعدادات العامة - تم إضافة التكوين هنا
# ==============================================
...
def format_no_signal(pair, tf):
    return f"━━━━━━━━━━━━━━━━━━━━\n⚡ {otc(pair)} | {tf}\n⚠️ السوق متذبذب حالياً - لا يوجد ميل واضح\n━━━━━━━━━━━━━━━━━━━━"
...
def on_command(cid, txt):
    if txt.strip() in ["/start", "/menu"]:
        send(cid,
            ...
            "✅ طبقة أخبار اقتصادية للتحذير من الأخبار المؤثرة\n"
            "✅ ADX + RSI كعوامل تسجيل نقاط متدرجة\n"
            "✅ تأكيد الفريم الثانوي بالاتجاه فقط\n"
            "✅ فريمات: 1د، 2د، 5د، 15د، 30د، ساعة\n"
            "✅ تكوينات شموع موسّعة\n\n"
